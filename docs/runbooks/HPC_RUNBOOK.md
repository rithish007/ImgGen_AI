...
Run `python tools/pod_preflight.py` here too (it's not RunPod-specific -
...
python -m archive.generators.generate --model klein --manifest manifests/2-pilot.json --out outputs/2-pilot/klein
```
