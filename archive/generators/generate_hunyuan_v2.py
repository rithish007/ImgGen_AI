...
sensibly.
    ...
    # smoke test first
    python -m archive.generators.generate_hunyuan_v2 --manifest manifests/2-pilot.json --limit 3 --out outputs/hunyuan/v2/smoke

    # full run
    python -m archive.generators.generate_hunyuan_v2 --manifest manifests/2-pilot.json --out outputs/hunyuan/v2
...
from imggen.prompts.legacy.hunyuan_v2 import build_prompt
