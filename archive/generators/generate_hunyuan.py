...
a standard transformers architecture.
    ...
    python -m archive.generators.generate_hunyuan --manifest manifests/2-pilot.json --limit 3 --out outputs/3-pilot/hunyuan_smoke

    # full run
    python -m archive.generators.generate_hunyuan --manifest manifests/2-pilot.json --out outputs/3-pilot/hunyuan
