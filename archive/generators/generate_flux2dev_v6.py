"""Stage 1 generation - flux2dev, EXPERIMENTAL - camera_height forced to "far" (5-8m above the seabed), a much bigger jump than the earlier "high" (1.5-2m) test, plus a new subject-scale guard."""
