"""Stage 1 generation - 5-pilot v5: flux2dev with DUO-domain-match fixes on top of v4 (kelp/coral removed, muted colour-palette guard, blue starfish variant, less "product photography" close framing)."""
