...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=Path("reports/analysis/real_eval_summary.json"))
    args = ap.parse_args()

    if not args.data.exists():
        raise SystemExit(f"{args.data} not found - run: python -m imggen.data.prepare_real_eval")
