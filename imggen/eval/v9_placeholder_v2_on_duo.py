"""Detect + score the v9_flux2dev_placeholder_dr_v2 model (placeholder DR,
label-fix applied, trained with the heavier MuSGD/mosaic-0.95/mixup-0.35/
copy_paste-0.35/scale-0.9/freeze-10 regime - see
imggen/train/v9_placeholder_v2.py) against the real DUO test set, and merge
...
imggen/eval/v9_on_duo.py and friends. Mirrors that script's pattern exactly.
    ...
    python -m imggen.eval.v9_placeholder_v2_on_duo
"""
