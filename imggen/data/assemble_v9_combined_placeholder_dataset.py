...
def main() -> None:
    ...
    ap.add_argument("--v9-dr-images-dir", type=Path, default=Path("outputs/flux2dev/v9/dr_runs/v1/dr"))
    ...
    ap.add_argument("--starfish-dr-images-dir", type=Path, default=Path("outputs/flux2dev/v9_starfish/dr_runs/v1/dr"))
    ap.add_argument("--out-dir", type=Path, default=Path("dataset/v9_flux2dev_combined_placeholder_dr"))
    ...
    print(f"{len(stems)} image_id groups, {missing_v9_dr} missing v9 placeholder DR, {missing_sf_dr} missing starfish placeholder DR")
