"""Build a YOLO-format dataset from flux2dev v9's base images COMBINED with their duo_calibrated_scatter DR'd copies (base images get domain-randomized into additional variants, not replaced - matching this project's established DR convention, see imggen/data/assemble_dataset.py)."""
