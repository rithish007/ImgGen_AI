...
def main() -> None:
    ...
    ap.add_argument("--dr-images-dir", type=Path, default=Path("outputs/flux2dev/v9/dr_runs/v1/dr"))
    ap.add_argument("--dr-suffix", default="_dr")
    ap.add_argument("--out-dir", type=Path, default=Path("dataset/v9_flux2dev_placeholder_dr"))
