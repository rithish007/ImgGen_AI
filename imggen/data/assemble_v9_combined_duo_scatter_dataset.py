"""Build a YOLO-format dataset combining BOTH flux2dev v9 base sets (the original v8-prompt run and the starfish-camouflage-prompt run, see assemble_v9_combined_dataset.py) with their duo_calibrated_scatter-profile DR'd copies (imggen/dr/randomize_v2.py - color calibration plus the scattering/contrast/noise stage)."""
