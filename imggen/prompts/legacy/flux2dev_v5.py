"""Prompt engine v5 - domain-match fixes on top of v4, driven by direct ground-truth feedback on the real DUO dataset this pipeline is meant to augment: "primary scene environment ..."""
