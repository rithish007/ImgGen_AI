"""Hunyuan-specific fork of prompts.py - duplicated rather than edited in place so the shared klein/flux2dev prompt engine stays untouched and reproducible."""
