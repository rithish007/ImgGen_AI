"""Prompt engine v4 - two more fixes on top of v3, both for flux2dev: the starfish multi-class undercount, and a genuine (not paraphrase) expansion of the scene/algae/lighting pools to address the "scenes repeat" finding."""
