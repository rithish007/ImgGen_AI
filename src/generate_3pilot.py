...
_load_flux2dev_multi_gpu() below before debugging from scratch.
    ...
    python src/generate_3pilot.py --model flux2dev --manifest manifests/2-pilot.json --limit 3 --out outputs/3-pilot/flux2dev_smoke

    # full run
    python src/generate_3pilot.py --model flux2dev --manifest manifests/2-pilot.json --out outputs/3-pilot/flux2dev
