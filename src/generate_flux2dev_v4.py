...
_load_flux2dev_multi_gpu() below before debugging from scratch.
    ...
    python src/generate_flux2dev_v4.py --model flux2dev --manifest manifests/2-pilot.json --limit 3 --out outputs/flux2dev/v4/smoke

    # full run
    python src/generate_flux2dev_v4.py --model flux2dev --manifest manifests/2-pilot.json --out outputs/flux2dev/v4
